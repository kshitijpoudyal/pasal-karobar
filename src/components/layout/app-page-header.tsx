...
export function AppPageHeader({ title }: AppPageHeaderProps) {
  return (
    <header className="sticky top-0 z-30 flex h-20 w-full min-w-0 shrink-0 items-center border-b border-surface-container-high bg-surface/90 px-6 backdrop-blur-xl xl:h-24 xl:px-12">
